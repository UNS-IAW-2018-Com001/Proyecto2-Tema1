...
const postUser=function(req,res){
  user.update({provider_id: req.body.elemento.provider_id}, {provider:  req.body.elemento.provider}, {name :  req.body.elemento.displayName}, {photo:  req.body.elemento.photos[0].value} ,{css: req.body.elemento.css},
